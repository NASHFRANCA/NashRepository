...
-- MAGIC %md 
-- MAGIC
-- MAGIC ### This is my Header
-- MAGIC
-- MAGIC * this is the start of the bullets
-- MAGIC * second bullet
-- MAGIC
-- MAGIC
-- MAGIC Links/Embedded HTML: <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">Rick Rolled Bitch</a>
-- MAGIC
